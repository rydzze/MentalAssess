...
<body>
    ...
    <form action="/depression" method="post">
        ...
        <label>Do you feel hopeless or worthless often?</label><br>
        <input type="radio" name="hopelessness" value="yes" required> Yes<br>
        <input type="radio" name="hopelessness" value="no" required> No<br><br>

...
<body>
    ...
    <form action="/anxiety" method="post">
        ...
        <label>Do you experience a racing heart or palpitations?</label><br>
        <input type="radio" name="palpitations" value="yes" required> Yes<br>
        <input type="radio" name="palpitations" value="no" required> No<br><br>
